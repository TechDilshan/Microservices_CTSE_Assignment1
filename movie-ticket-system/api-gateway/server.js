...
const reviewProxy = require("./routes/review.proxy")
const discountProxy = require("./routes/discount.proxy")
const analyticsProxy = require("./routes/analytics.proxy")
